...
# разрадность ОС - 64bit, версия Python - 3.6.7
...
т.е. функция cycle_sum() использует 14.3 Мбайт без приращений памяти
"""

"""
Вторая задача:
Нахождение i-ого простого числа через решето Эратосфена
"""
@profile
...
т.е. функция find_prime_erotosfen() использует 14.7 Мбайт, причём приращение в 0.3 Мбайт (с 14.3 до 14.7) было вызвано созданием массива для решета Эратосфена
"""

"""
Третья задача:
Нахождение i-ого простого числа без использования решета Эратосфена
"""
...
т.е. функция find_prime() использует 14.5 Мбайт без каких-либо приращений по памяти
"""
